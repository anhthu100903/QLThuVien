...
//        System.out.println(Sach_DAO.getInstance().add(sach1));
        ...
        PhieuNhapSach phieuNhapSach1 = new PhieuNhapSach("PN124", date1);
        PhieuNhapSach_DAO.getInstance().add(phieuNhapSach1);
        ChiTietPhieuNhapSach chiTietPhieuNhapSach1 = new ChiTietPhieuNhapSach("PN124", "N0031", "Hoang Tu Be", "TG0020", "TL019", "NXB Tre", 2011, 10, 101200.9);
